To apply the algorithm it is necessary to execute the command: java -jar FARCI+.jar param.txt
...
The explanation about the execution of the method using the KEEL structure is made in the .rar file containing the source code of FARCI: source_code_FARCI+.zip (see the Readme file of that folder).